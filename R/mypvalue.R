#' Title
#'
#' @importFrom stats qt dt pt
#'
#' @param t0 tcalc value
#' @param xmax bound of the x-axis
#' @param n Number of values in the sample
#' @param alpha alpha value (if 0.05 then 95 percent C.I.)
#'
#' @return plot of normal curve and quantiles, pvalue and q value
#' @export
#'
#' @examples
#' tcalc = 1.326252
